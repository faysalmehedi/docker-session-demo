...
* The original package name 'com.pwc.microservices.netflix-eureka-naming-server' is invalid and this project uses 'com.pwc.microservices.netflixeurekanamingserver' instead.
